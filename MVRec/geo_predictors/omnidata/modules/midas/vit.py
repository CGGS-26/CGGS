...
def forward_flex(self, x):
    ...
    # print(f"\n\nPos Embed shape: {pos_embed.shape}\n\n")
    # # # Pos Embed shape: (1, 962, 768)    but supposed to be (1, 1025, 768)!

    pos_embed = pos_embed.permute(0, 2, 1)  
    pos_embed = F.interpolate(pos_embed, size=1025, mode='linear', align_corners=False)  
    pos_embed = pos_embed.permute(0, 2, 1)
    ...
    # print(f"\n\nX shape: {x.shape}\n\n")
    # # X shape: torch.Size([1, 1024, 32, 32])
